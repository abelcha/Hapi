  ...
  PixelAdminApp.prototype.start = function(init, settings) {
    ...
    if (settings == null) {
      settings = {};
        ...
        this.settings = $.extend(true, {}, SETTINGS_DEFAULTS, settings || {});
        this.settings.is_mobile = /iphone|ipad|ipod|android|blackberry|mini|windows\sce|palm/i.test(navigator.userAgent.toLowerCase());
