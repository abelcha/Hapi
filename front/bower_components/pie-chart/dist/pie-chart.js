...
.directive('pieChart', ['$utils', function($utils) {
  var link  = function($scope, element, attrs, ctrl) {
    ...
    var updateDimensions = function(dimensions) {
      dimensions.width = element.context.attributes.width.nodeValue || element[0].parentElement.offsetWidth || 900;
      dimensions.height =element.context.attributes.height.nodeValue || element[0].parentElement.offsetHeight || 500;
    };
